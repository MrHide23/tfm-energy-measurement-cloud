\section{Selección de Herramienta para la toma de Métricas de Consumo}
En esta primera fase de experimentación se llevará a cabo un test entre las diferentes herramientas disponibles para la toma de métricas de consumo sobre cargas de trabajo desplegadas en contenedores. Estas cargas de trabajo están basadas en la codificación de video y se llevarán a cabo empleando la herramienta \textbf{ffmpeg}.

Únicamente se utilizará un video para esta fase experimental, ya que el objetivo principal es determinar qué herramienta es capaz de tomar el conjunto de métricas de consumo más precisas. Este video tendrá una duración de 50 segundos con un CRF 0 a una calidad 4K y con un bitrate de 1012693 kbps (1012,693 Mbps). Pese a que no es un video con una gran duración, tiene una gran calidad con 0 pérdida y un bitrate muy elevado, proporcionando sufiente carga de trabajo al codificador. Permitiendo extraer suficientes métricas  en un tiempo prolongado del proceso de codificación mediante CPU y GPU, ya que, por lo general, los códecs que utilizan la GPU para llevar a cabo la codificación son notablemente más rápidos que los codificadores que utilizan codificación únicamente sobre CPU.
...
\subsubsection{Escenario 1: Transcodificacion sobre un contenedor empleando CPU y GPU}
 ...
 \begin{figure}[h!]
    \centering
    \includegraphics[scale=0.38]{figs/exp1-1cont-nolimitcpuygpu.png}
