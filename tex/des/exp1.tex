...
\input{tex/des/exp1/exp1-enviroment.tex}
...
% - Comparando los datos obtenidos, se puede observar que la herramienta MONITORING es mucho mas efectiva, tanto en la estimacion de consumo del nodo como en la toma de metricas
%   multiples procesos ejecutandose simultanemente. Los resultados obtenido de la experimentacion se pueden observar a continuacion en la tabla REF TABLA
% 
