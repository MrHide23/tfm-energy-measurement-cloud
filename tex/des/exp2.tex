...
En esta segunda subfase de experimentacion perteneciente al seccion \textbf{Consumo energetico en relacion al SITI y el Numero de Threas}\ref{exp2-desarrollo}, se ha analizado el consumo energetico de un proceso de transcodificacion llevado a cabo sobre un contenedor de docker con limitaciones de acceso a los cores de la CPU y con limitaciones en la cantidad de threads a nivel de codificador.  Bajo esta premisa se han desarrollado los experimentos siguientes, tratando de encontrar la relacion entre el consumo energetico, el tiempo de codificacion,y el numero de cores y threads disponibles. 

Asi pues, para esta subfase experimental se han utilizado el conjunto de \textit{videos} \ref{tab:exp2.2-videos} creados y clasificados para la subfase \textbf{Consumo energetico en relacion al SITI}\ref{section:exp2.2-sitixconsumo}. De este conjunto de videos se han seleccionado 
