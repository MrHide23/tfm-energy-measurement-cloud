...
\begin{itemize}
    ...
    \item \texttt{Tasa de bits (Bitrate):} Variable clave en los Experimentos 2 y 3. Rango de valores en Mbps según el estandar del códec (H.264 o H.265), detallado en la Tabla \ref{tab:ana-bitrate-values}.
...
\begin{table}[htbp]
  ...
  \end{tabular}
  \caption{Valores de bitrate (Mbps) configurados por experimento y estandar de códec.}
