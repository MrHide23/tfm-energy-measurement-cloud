\section{Análisis}
 ...
 \caption{Diagram de funcionamiento interno del experimento 1.1 recoleccion de métricas con Kepler y Global Energy Meter}
 ...
 \centering
 \includegraphics[width=\linewidth]{figs/kepler-caso-uso.png}
 \caption{Diagram de funcionamiento interno del experimento 1.2 recoleccion de métricas con Scaphandre y Global Energy Meter}
 ...
 \caption{Diagram de funcionamiento interno del experimento 1.2 recoleccion de métricas con Container Eneregy Monitoring y Global Energy Meter}
...
\begin{itemize}
    ...
    \item \texttt{Tasa de bits (Bitrate):} Variable clave en los Experimentos 2 y 3. Rango de valores en Mbps según la generación del códec (H.264 o H.265), detallado en la Tabla \ref{tab:ana-bitrate-values}.
...
\begin{table}[htbp]
  ...
  \end{tabular}
  \caption{Valores de bitrate (Mbps) configurados por experimento y generación de códec.}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\columncolor[HTML]{EFEFEF}}c |c|c|}
    \hline
    \rowcolor[HTML]{C0C0C0}
    \textbf{Códec} & \textbf{CPU Host} & \textbf{GPU Acelerada} \\ \hline
    libx264     & X & - \\ \hline
    libx265     & X & - \\ \hline
    h264\_nvenc & X & X \\ \hline
    hevc\_nvenc & X & X \\ \hline
  \end{tabular}
  \caption{Matriz de códecs y plataforma de ejecución hardware.}
