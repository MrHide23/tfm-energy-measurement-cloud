...
\subsection{Estandares de Codificación}
 ...
 Estos estándares representan una nueva generación de códecs que buscan incrementar la eficiencia de compresión y adaptarse a las nuevas demandas de consumo de vídeo, aunque con diferentes compromisos en términos de complejidad computacional, eficiencia y licenciamiento \cite{codecs-landscape}. Refiriendo nuevamente al análisis llevado a cabo por \textit{Bitnovo 2025-26: the 9th annual bitnovin video developer report}, para el año $2026$ se espera un aumento del uso de los codecs \textit{AV1} del $21\%$ y \textit{VCC} con un aumento del $8\%$, afirmando una tendencia clara de transición sobre los codecs \textit{H.264} y \textit{HEVC}.
